...
###############################################################################
# Destination of file output and file prefix for the data record


if not os.path.exists('simulation_output_example_brunel/spiking_output_path'):
    os.makedirs('simulation_output_example_brunel/spiking_output_path')
...
###############################################################################
# Main part of the simulation script

def simulation():
    '''instantiates the network and simulates it'''
    nest.ResetKernel()
    ...
    espikes.set(label=os.path.join(spike_output_path, label + "-EX"), 
                record_to="ascii")
    ispikes.set(label=os.path.join(spike_output_path, label + "-IN"),
                record_to="ascii")
